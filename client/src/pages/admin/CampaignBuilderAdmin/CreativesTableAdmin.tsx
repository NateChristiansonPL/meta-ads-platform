...
import AssetDropCell, { AssetFile } from '@/components/AssetDropCell';
import MediaBrowserModal, { MediaSelection } from './MediaBrowserModalAdmin';
...
function AssetUploadModal({ settings, onClose }: AssetUploadModalProps) {
  ...
  const uploadImageMut = trpc.adminMeta.uploadImage.useMutation();
  const uploadVideoMut = trpc.adminMeta.uploadVideo.useMutation();
